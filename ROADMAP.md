...
### תשתית וחוויית משתמש
- **מרכז החוסרים — סינון לחיצות-כפולות מהכשלים** — **מקומי, ממתין ל-push+deploy**
  (`fix/incompleteness-double-click-noise` @ `090ccc7`). המשך ישיר של המשימה מתחת:
  חקירה גילתה שהמונה (82) **מנופח** בלחיצות-כפולות. יצחק סייג 24.07: יציאה מוצלחת
