...
### תשתית וחוויית משתמש
- **גלריה — הסרת המספור מכרטיסי הפרויקטים** — **נבנה, ממתין ל-push**
  (21.7.26, `fix/remove-project-numbering`, commit מקומי `f761197`).
  ...
  **הופעה שלישית לא נגעה — טעונה הכרעה:** watermark 120px באטימות 6% ב-hero
  של 5 הדפים העשירים ([`src/data/projects`](src/data/projects/) →
  `he|en/projects/[slug]/page.tsx`). build נקי, 408 טסטים.
