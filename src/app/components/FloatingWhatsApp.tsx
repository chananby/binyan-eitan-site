...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      aria-label={label}
      className="fixed bottom-24 end-6 z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 hover:bg-[#20bb5a] transition-colors duration-300"
