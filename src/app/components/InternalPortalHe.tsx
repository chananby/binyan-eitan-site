...
export default function InternalPortalHe() {
  return (
    <main className="min-h-screen bg-bone" dir="rtl">
        <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
          ...
          <div className="mt-12 pt-8 border-t border-charcoal/10">
            <Link href="/he" className="font-body text-xs text-charcoal/35 hover:text-charcoal/60 transition-colors duration-200 tracking-wide">
              ← חזרה לאתר
            </Link>
          </div>
        </div>
