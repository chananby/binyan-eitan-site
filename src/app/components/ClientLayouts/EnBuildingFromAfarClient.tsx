...
export default function EnBuildingFromAfarClient() {
  return (
    <main className="relative bg-bone" dir="ltr">
      ...
      <section className="py-24 px-8 max-w-3xl mx-auto">
        ...
        <motion.p className="text-lg text-charcoal/80 mb-10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          Working across a seven-hour time difference doesn’t have to be a barrier. We provide daily progress reports, clear communication, and full transparency to clients in Europe and the Americas.
        </motion.p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <motion.h2 className="text-2xl font-semibold text-charcoal mb-4">Daily Reports &amp; Communication</motion.h2>
          ...
          <div>
            <motion.h2 className="text-2xl font-semibold text-charcoal mb-4">International Material Integration</motion.h2>
            <motion.p className="text-base text-charcoal/80" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
