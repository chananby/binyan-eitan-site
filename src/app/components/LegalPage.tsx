  ...
  return (
    <>
      ...
      <Section title="1. כללי">
        <P>אתר זה ("האתר") מופעל על-ידי חברת בניין איתן בע"מ ("בניין איתן", "אנחנו"). כניסתך לאתר ושימושך בו מהווים הסכמה לתנאי שימוש אלו. אם אינך מסכים לתנאים, אנא אל תעשה שימוש באתר.</P>
      </Section>
      ...
      <Section title="3. קניין רוחני">
        <P>כל התוכן באתר זה — לרבות טקסט, תצלומים, גרפיקה, לוגואים ועיצוב — הינו רכושה הבלעדי של חברת בניין איתן בע"מ ומוגן בהתאם לחוק זכויות יוצרים תשס"ח-2007 ולדיני קניין רוחני הרלוונטיים. כל התמונות המוצגות באתר הן לצרכי המחשה בלבד ואינן מייצגות בהכרח פרויקטים שהושלמו, אלא אם צוין אחרת.</P>
      ...
      <Section title="4. הגבלת אחריות">
        ...
        <P>בניין איתן לא תהיה אחראית לכל נזק עקיף, מקרי, מיוחד או תוצאתי הנובע מהשימוש באתר.</P>
      </Section>
  ...
  return (
    <>
      ...
      <Section title="1. בעל המידע">
        <P>חברת בניין איתן בע"מ, הפועלת מירושלים ולוד, היא בעל המידע לכל מידע אישי הנאסף דרך אתר זה. ניתן ליצור קשר בכתובת: <a href="mailto:office@binyaneitan.com" className="text-accent hover:underline">office@binyaneitan.com</a> | טל&#39;: <a href="tel:+97225000447" className="text-accent hover:underline">02-500-0447</a></P>
      </Section>
  ...
  return (
    <>
      ...
      <Section title="מחויבותנו לנגישות">
        <P>חברת בניין איתן בע"מ מחויבת להנגיש את נוכחותה הדיגיטלית לכלל המשתמשים, לרבות אנשים עם מוגבלויות. אנו מאמינים כי גישה שווה למידע הינה זכות יסוד, ושואפים להבטיח שהאתר עומד בדרישות חוק שוויון זכויות לאנשים עם מוגבלות, תשנ"ח-1998 ותיקון מס' 2 לו, המחייב נגישות לשירותים הפתוחים לציבור.</P>
      </Section>
