          ...
          {testimonials.map((t, i) => {
            ...
            return (
              <motion.div
                ...
                className={`flex flex-col bg-white border border-warm-gray-light p-7 shadow-sm hover:shadow-md transition-shadow duration-300${i === 6 && testimonials.length % 3 === 2 ? " lg:col-start-2" : ""}`}
              >
                {/* Stars */}
                <div className="mb-4">
