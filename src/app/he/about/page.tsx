...
export const metadata: Metadata = {
  ...
  description: 'מזה שני עשורים שחברת "בנין איתן" מובילה פרויקטים מורכבים ויוקרתיים בישראל. מוטי איתן, מייסד ובעלים — מעל 20 שנה של הנדסת קונסטרוקציה, פיקוח וניהול פרויקטים.',
  keywords: [
    "קבלן רשום ג1",
    "בנייה פרטית וציבורית",
    "הנדסת קונסטרוקציה ישראל",
    "מוטי איתן קבלן",
    "בניין איתן",
