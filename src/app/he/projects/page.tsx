...
// Note: Metadata cannot be exported in client components, export separately below
const mdMetadata = {
...
const projects = [
  {
    ...
    description:
      "פיתוח מסחרי דגל בתיאום של הנדסה חדשנית וטכנולוגיה מתקדמת באופן מיוחד.",
  ...
  },
  {
    ...
    category: "דיור פרטי",
    description:
      "אחוזה דיור פרימיום עם עיצוב אלגנטי, קרל-מנות ומרץ אדריכלי חסר זמן.",
    features: ["גימורים מקוסטמים", "מערכות חכמות מתקדמות", "חומרים בנימה"],
    image: "gradient-from-[#B8A390] to-[#8D775F]",
  },
];

export default function ProjectsPageHebrew() {
  return (
