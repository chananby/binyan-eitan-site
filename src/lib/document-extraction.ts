...
כללי direction: מסמך שבו בניין איתן בע"מ היא המשלמת/המקבלת שירות → expense; מסמך שבניין איתן הפיקה ללקוח או אישור כסף נכנס בפועל → income; מסמך שאינו תנועת כסף בפועל (הצעת מחיר, תעודת משלוח, או כל מסמך שאינו חשבונית/קבלה/העברה/דרישת תשלום) → none.
