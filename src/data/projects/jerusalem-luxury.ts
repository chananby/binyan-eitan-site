...
const jerusalemLuxury: ProjectData = {
  ...
  galleryImages: [
    { src: img("jerusalem-luxury-living-room.jpg") },
    { src: img("jerusalem-black-sink-detail.jpg") },
    { src: img("jerusalem-balcony-view.jpg") },
    { src: img("jerusalem-stone-drilling-detail.jpg") },
    { src: img("jerusalem-site-inspection-motti.jpg") },
    { src: img("jerusalem-crane-logistics.jpg") },
  ],
  dateCompleted: "",
